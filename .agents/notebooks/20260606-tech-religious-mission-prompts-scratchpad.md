...
ACTION: Inspect existing `.agents/docs` files and upstream replication outputs.
OBSERVATION:

- Source: local project files
- Version: n/a
- Key Facts: Existing reports and synthesis map exist; same-topic replication output exists at `.agents/docs/20260605-replication-religious-vs-nonreligious-prompts.md` with handoff block and concrete artifacts.
...
ACTION: Write revised `.agents/docs/20260605-literature-religious-vs-nonreligious-mission-prompts.md`.
OBSERVATION:
