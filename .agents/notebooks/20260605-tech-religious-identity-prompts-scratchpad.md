...
- Replication-seeker output: `.agents/docs/20260605-replication-religious-vs-nonreligious-prompts.md` and `.agents/docs/20260605-replication-religious-nonprofit-mission.md`
...
- [ ] Save final report in `.agents/docs/` with requested filename prefix.
...
ACTION: glob/read local `.agents/docs/*-replication-*.md`; selected religious prompt and religious nonprofit mission outputs.
OBSERVATION:

- Source: `.agents/docs/20260605-replication-religious-vs-nonreligious-prompts.md`, `.agents/docs/20260605-replication-religious-nonprofit-mission.md`
