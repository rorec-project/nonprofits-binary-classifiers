...
reports:
  - .agents/docs/20260605-replication-weak-supervision-noisy-labels.md
  - .agents/docs/20260605-replication-imbalanced-validation.md
  - .agents/docs/20260605-replication-calibration-prevalence.md
  - .agents/docs/20260605-replication-short-text-model-alternatives.md
...
|---|---|---|---|
| Weak supervision, LLM labels, noisy-label fine-tuning | `.agents/docs/20260605-replication-weak-supervision-noisy-labels.md` | `.agents/notebooks/20260605-replication-weak-supervision-noisy-labels-scratchpad.md` | Complete |
| Imbalanced validation and metrics | `.agents/docs/20260605-replication-imbalanced-validation.md` | `.agents/notebooks/20260605-replication-imbalanced-validation-scratchpad.md` | Complete |
| Calibration and prevalence estimation | `.agents/docs/20260605-replication-calibration-prevalence.md` | `.agents/notebooks/20260605-replication-calibration-prevalence-scratchpad.md` | Complete |
| Short-text model alternatives | `.agents/docs/20260605-replication-short-text-model-alternatives.md` | `.agents/notebooks/20260605-replication-short-text-model-alternatives-scratchpad.md` | Complete |
| Religious nonprofit mission classification | `.agents/docs/20260605-replication-religious-nonprofit-mission.md` | `.agents/notebooks/20260605-replication-religious-nonprofit-mission-scratchpad.md` | Complete |
| Religious vs nonreligious prompt/codebook artifacts | `.agents/docs/20260605-replication-religious-vs-nonreligious-prompts.md` | `.agents/notebooks/20260605-replication-religious-vs-nonreligious-prompts-scratchpad.md` | Complete |
