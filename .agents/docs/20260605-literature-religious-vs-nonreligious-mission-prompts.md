...
scratchpad: .agents/notebooks/20260605-literature-religious-vs-nonreligious-mission-prompts-scratchpad.md
status: complete
...
1. Read local synthesis/background: `.agents/docs/20260605-literature-synthesis-map.md`; `.agents/docs/20260605-literature-religious-identity-prompts.md`; `.agents/docs/20260605-literature-religious-nonprofit-classification.md`; `.agents/docs/20260605-literature-llm-weak-supervision-noisy-labels.md`.
