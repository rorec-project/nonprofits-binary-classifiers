...
reports:
  - .agents/docs/20260606-tech-llm-weak-supervision-noisy-labels.md
  - .agents/docs/20260606-tech-imbalanced-text-evaluation.md
  - .agents/docs/20260606-tech-calibration-quantification-prevalence.md
  - .agents/docs/20260606-tech-short-text-model-alternatives.md
  - .agents/docs/20260606-tech-religious-nonprofit-mission.md
  - .agents/docs/20260606-tech-religious-identity-prompts.md
  - .agents/docs/20260606-tech-religious-vs-nonreligious-mission-prompts.md
---
...
|---|---|---|---|
| LLM annotators, weak supervision, noisy labels | `.agents/docs/20260606-tech-llm-weak-supervision-noisy-labels.md` | `.agents/notebooks/20260606-tech-llm-weak-supervision-noisy-labels-scratchpad.md` | Complete |
| Imbalanced text evaluation | `.agents/docs/20260606-tech-imbalanced-text-evaluation.md` | `.agents/notebooks/20260606-tech-imbalanced-text-evaluation-scratchpad.md` | Complete |
| Calibration, quantification, prevalence | `.agents/docs/20260606-tech-calibration-quantification-prevalence.md` | `.agents/notebooks/20260606-tech-calibration-quantification-prevalence-scratchpad.md` | Complete |
| Short-text model alternatives | `.agents/docs/20260606-tech-short-text-model-alternatives.md` | `.agents/notebooks/20260606-tech-short-text-model-alternatives-scratchpad.md` | Complete |
| Religious nonprofit mission classification | `.agents/docs/20260606-tech-religious-nonprofit-mission.md` | `.agents/notebooks/20260606-tech-religious-nonprofit-mission-scratchpad.md` | Complete |
| Religious identity prompts/triggers | `.agents/docs/20260606-tech-religious-identity-prompts.md` | `.agents/notebooks/20260605-tech-religious-identity-prompts-scratchpad.md` | Complete; separated from the literature handoff. |
| Religious vs nonreligious mission prompts | `.agents/docs/20260606-tech-religious-vs-nonreligious-mission-prompts.md` | `.agents/notebooks/20260606-tech-religious-mission-prompts-scratchpad.md` | Complete; separated from the literature handoff. |
