...
- Replication-seeker output: `docs/research/20260605-replication-short-text-model-alternatives.md`
...
ACTION: Glob/read `docs/research/*-replication-*.md`; select complete same-topic file.
OBSERVATION:

- Source: `docs/research/20260605-replication-short-text-model-alternatives.md`
