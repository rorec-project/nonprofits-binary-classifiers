...
- [ ] Produce output report under `docs/research/` with required handoff blocks and explicit empty/not-found markers.
...
ACTION: Read upstream reports and handoff citation lists from `docs/research/20260605-literature-religious-nonprofit-classification.md`, `docs/research/20260605-literature-synthesis-map.md`, and `docs/research/20260605-literature-religious-identity-prompts.md`.
OBSERVATION:

- Source: local `docs/research/` reports.
