...
- Replication-seeker output: `docs/research/20260605-replication-imbalanced-validation.md`
...
ACTION: Glob[docs/research/*-replication-*.md] and frontmatter filtering
OBSERVATION:

- Source: Local docs/research replication outputs
- Version: N/A
