...
scratchpad: docs/research/notebooks/20260605-replication-weak-supervision-noisy-labels-scratchpad.md
status: complete
...
Scope was bounded by `docs/research/20260605-literature-llm-weak-supervision-noisy-labels.md`, the synthesis map, and the user priority list. I searched Dataverse, OSF, Zenodo, OpenICPSR, GitHub, ACL/OpenReview/PapersWithCode-style pages, and author/project pages.
