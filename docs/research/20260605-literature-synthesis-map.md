...
reports:
  - docs/research/20260605-literature-llm-weak-supervision-noisy-labels.md
  - docs/research/20260605-literature-imbalanced-text-validation.md
...
|---|---|---|
| Annotation, weak supervision, and noisy labels | LLM-as-annotator, weak supervision, fine-tuning on noisy/programmatic labels, LLM-generated label recipes | `docs/research/20260605-literature-llm-weak-supervision-noisy-labels.md` |
| Imbalanced validation and metrics | Evaluation metrics for imbalanced text classification in social science | `docs/research/20260605-literature-imbalanced-text-validation.md` |
| Calibration and prevalence estimation | Population-scale prevalence, calibrated transformer classifiers, misclassification correction | `docs/research/20260605-literature-calibrated-classifier-prevalence.md` |
| Model alternatives and fine-tuning | BERT, RoBERTa, DeBERTa, DistilBERT, ELECTRA, SBERT/MiniLM, small open-weight LMs, fine-tuning recipes | `docs/research/20260605-literature-short-text-classification.md` |
| Religious/nonprofit domain measurement | Religious organization or nonprofit mission classification, NTEE/Form 990, faith-based organization constructs | `docs/research/20260605-literature-religious-nonprofit-classification.md` |
