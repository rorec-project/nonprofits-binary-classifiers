...
scratchpad: docs/research/notebooks/20260605-replication-imbalanced-validation-scratchpad.md
status: complete
...
Scope came from `docs/research/20260605-literature-imbalanced-text-validation.md` plus the user’s priority list. I searched Dataverse, OpenICPSR, OSF, Zenodo, GitHub, JMLR/ACL/PLOS/OpenReview/Cambridge artifact links, and author pages.
