...
A single `HF_HOME=/work/<DATA_DRIVE>/hf-cache` covers the encoders (`deberta-v3-base`, `ModernBERT-base`, `all-MiniLM-L6-v2`) **and** the vLLM Gemma and DeepSeek-V4-Flash downloads, so they share one reusable cache across projects.
